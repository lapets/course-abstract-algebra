...
PHP 5.4 or later and [Sheaf](http://sheaf.io) are required. The latest version of Sheaf is already included in this repository. In a Linux environment, it is possible to build the HTML version of the notes as follows:
